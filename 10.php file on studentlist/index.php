//first install xampp and inthat start apache and mysql close it
//save each file on ocaldisk c: ,xampp,in that htdocs
//open chrome
//type localhost/index.php
//localhost/header.php
//localhost/add.php and so on
<?php
include 'header.php';
?>
<div id="main-content">
